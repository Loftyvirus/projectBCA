  ...
  return (
    ...
    >
      <section className="bg-[#3730a3] text-white py-32 lg:py-48 px-6">
        <div className="container mx-auto flex items-center justify-between flex-col lg:flex-row">
          <div className="text-left mb-12 lg:mb-0 lg:w-2/3">
            <h1 className="text-4xl lg:text-5xl font-extrabold mb-6 leading-tight max-w-3xl">
            ...
            <button className="px-8 py-3 bg-[#4c41d0] text-white rounded-lg text-lg hover:bg-[#3730a3] transition-all focus:outline-none">
              Explore Papers
            </button>
          </div>
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="w-full bg-gray-100 text-gray-700 text-center p-4 rounded-md mt-4">
